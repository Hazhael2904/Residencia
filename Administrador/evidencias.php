...
if(isset($_POST['upload'])){
	...
	$path = 'evidencia/'.$image;

	$sql = $con->query("INSERT INTO evidencias (image_path) VALUES ('$path')");
...
$result = $con->query("SELECT image_path from evidencias");
...
<body>
	<h2 class="text-center bg-dark text-light pb-2">Evidencias de Proyectos</h2>
